...
alias diff_files='git diff master --name-only'
alias drg='diff_files | xargs rg -l'
alias dspec='diff_files | grep spec.rb | xargs bundle exec rspec'
alias dcop='diff_files | grep rb | xargs bundle exec rubocop --fail-level R'
